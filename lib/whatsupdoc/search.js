...
var ENGINES = require("narwhal/engine");
...
exports.searchAll = function (system, packages) {
    return exports.dub(exports.searchAllPredub(system, packages));
};
 ...
 * info object properties.
 */
exports.searchAllPredub = function (system, packages) {
    ...
    packages.order.forEach(function (info) {
        exports.searchPkgInfoPredub(info).forEach(function (find) {
            finds.push(find);
        });
    });
 ...
 * reconstruct module identifiers from each find.
 */
exports.searchPkgInfoPredub = function (info) {
    ...
    ENGINES.engines.forEach(function (engine) {
